...
class AccessPythonDocs(unittest.TestCase):
    def setUp(self):
    ...
    def test_access_python_docs(self):
        driver = self.driver
        ...
        driver.find_element_by_link_text(u"sqlite3 — DB-API 2.0 interface for SQLite databases").click()
