...
class UntitledTestCase(unittest.TestCase):
    ...
    def test_untitled_test_case(self):
        driver = self.driver
        driver.get("http://www.chandrashekar.info/user")
        ...
        driver.find_element_by_id("edit-title").send_keys("aaaaa")
        driver.find_element_by_id("edit-body-und-0-value").click()
        driver.find_element_by_id("edit-body-und-0-value").click()
        driver.find_element_by_id("edit-body-und-0-value").clear()
        driver.find_element_by_id("edit-body-und-0-value").send_keys("sdfsdfsdfsdfsdfsfsdfsdfsdsdf")
